...
@Autonomous(name = "MechanumB", group = "PushBot")
public class MechanumB extends LinearOpMode {
    ...
    public void cs() {
        ...
        backRight.setPower(0.4); // moves forward
        sleep(1200);
        frontLeft.setPower(0.5);
        frontRight.setPower(-0.5);
        backLeft.setPower(0.5);
        backRight.setPower(-0.5); // turns right
        sleep(400);
        frontLeft.setPower(0.2);
        frontRight.setPower(0.2);
        backLeft.setPower(0.2);
        backRight.setPower(0.2); // moves forward
        sleep(1300);
        sleep(200);
        RightServo.setPosition(1);
        LeftServo.setPosition(0); // unclamps
        Arm.setPower(0.2); // raises clamp
        sleep(500);
        frontLeft.setPower(-0.2);
        frontRight.setPower(-0.2);
        backLeft.setPower(-0.2);
        backRight.setPower(-0.2); // moves backward
        sleep(200);
