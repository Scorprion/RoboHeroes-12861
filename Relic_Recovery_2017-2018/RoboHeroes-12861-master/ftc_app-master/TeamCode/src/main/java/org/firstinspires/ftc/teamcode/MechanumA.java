...
@Autonomous(name = "MechanumA", group = "PushBot")
public class MechanumA extends LinearOpMode {
    ...
    public void cs() {
        ...
        if (colors.blue > colors.red) {
            //detects Red
            pushyObject.setPosition(0.2); //moves pushyObject slightly
            sleep(100);
            pushyObject.setPosition(0); //moves pushyObject fully
            sleep(100);
            pushyObject.setPosition(0.4); //resets pushyObject
            sleep(100);
        ...
        sleep(2000);
            ...
            frontRight.setPower(0.3);//Moves forward
            backLeft.setPower(0.3);
            backRight.setPower(0.3);
            sleep(1800);
            frontLeft.setPower(0);
            frontRight.setPower(0);//Stops
            backLeft.setPower(0);
            backRight.setPower(0);
            sleep(500);
            frontLeft.setPower(-0.65);
            frontRight.setPower(0.65);
            backLeft.setPower(-0.65); //Turns Left
            backRight.setPower(0.65);
            sleep(700);
            frontLeft.setPower(0.35);
            frontRight.setPower(0.35);//Moves forward
