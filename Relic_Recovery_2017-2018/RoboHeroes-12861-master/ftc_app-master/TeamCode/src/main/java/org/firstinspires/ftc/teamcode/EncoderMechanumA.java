...
@Autonomous(name = "EncMechanumA", group = "PushBot")
public class EncoderMechanumA extends LinearOpMode {
    ...
    public void cs() {
        ...
        if (colors.blue > colors.red) {
            //detects Red
            robot.pushyObject.setPosition(0.2); //moves pushyObject slightly
            sleep(100);
            robot.pushyObject.setPosition(0); //moves pushyObject fully
            sleep(100);
            robot.pushyObject.setPosition(0.4); //resets pushyObject
            sleep(100);
        ...
        encoderDrive(DRIVE_SPEED, 11, 11, 11,11,4.0);  // S1: Forward 12 Inches with 5 Sec timeout
        encoderDrive(DRIVE_SPEED, -9, 9, -9,9,4.0);  // S3: Forward 3 Inches with 4 Sec timeout
