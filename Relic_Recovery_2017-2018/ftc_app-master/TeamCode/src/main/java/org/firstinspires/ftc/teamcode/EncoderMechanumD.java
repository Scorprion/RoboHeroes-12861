...
public class EncoderMechanumD extends LinearOpMode {
    ...
    public void cs() {
        ...
        if (colors.blue > colors.red) {
            ...
            sleep(100);
            robot.pushyObject.setPosition(0.45);
            sleep(100);
            robot.SensorArm.setPower(0.4); // raises arm
            //todo you changed the time from 350 -> 400
            sleep(400);
            robot.SensorArm.setPower(0);
            robot.frontLeft.setPower(0);
            robot.frontRight.setPower(0);
            ...
            robot.pushyObject.setPosition(0.4);
            sleep(100);
            robot.SensorArm.setPower(0.45); // raises arm
            //todo you changed the time from 350 -> 400
            sleep(400);
            robot.SensorArm.setPower(0);
            robot.frontLeft.setPower(0);
    ...
    public void movement() {
        ...
        if (choice == 1) {
            //Left
            encoderDrive(DRIVE_SPEED, -12,-12,-12,-12,3.5);
            encoderDrive(TURN_SPEED,-13,13,-13,13,3.0);
            encoderDrive(DRIVE_SPEED, 3,3,3,3,1.0);
            robot.RightServo.setPosition(0);
            robot.LeftServo.setPosition(1);
            sleep(500);
            encoderDrive(TURN_SPEED, 6,-6,6,-6,1.5);
            encoderDrive(DRIVE_SPEED, -3, -3, -3,-3,1.0);
            encoderDrive(TURN_SPEED,8,-8,8,-8,2.0);
        }
        if (choice == 2) {
            //Middle
            encoderDrive(DRIVE_SPEED, -9,-9,-9,-9,2.5);
            encoderDrive(TURN_SPEED,-13,13,-13,13,3.0);
            encoderDrive(DRIVE_SPEED, 3,3,3,3,1.0);
            robot.RightServo.setPosition(0);
            robot.LeftServo.setPosition(1);
        ...
        if (choice == 3) {
            //Right
            encoderDrive(DRIVE_SPEED, -10,-10,-10,-10,3.5);
            encoderDrive(TURN_SPEED,-9,9,-9,9,2.5);
            encoderDrive(DRIVE_SPEED, 4,4,4,4,1.0);
            robot.RightServo.setPosition(0);
            robot.LeftServo.setPosition(1);
            sleep(500);
            encoderDrive(DRIVE_SPEED, -3, -3, -3,-3,1.0);
            encoderDrive(TURN_SPEED,-7.5,7.5,-7.5,7.5,2.0);
        }
    }
