...
public class EncoderMechanumC extends LinearOpMode {
    ...
    public void movement() {
        ...
        if (choice == 1) {
            //Left
            encoderDrive(DRIVE_SPEED, -10,-10,-10,-10,2.5);  // S1: Forward 12 Inches with 5 Sec timeout
            encoderDrive(TURN_SPEED, 12,-12,12,-12,3.0);  // S2: Turn Right 6 Inches with 4 Sec timeout
            encoderDrive(DRIVE_SPEED, 6,6,6,6,1.5);  // S3: Forward 3 Inches with 4 Sec timeout
        ...
        if (choice == 2) {
            ...
            encoderDrive(DRIVE_SPEED, 4.5, 4.5, 4.5,4.5,1.0);  // S3: Forward 3 Inches with 4 Sec timeout
            encoderDrive(DRIVE_SPEED, 0, 0, 0,0,2.0);  // S4: Reverse 3 Inches with 4 Sec timeout
            robot.RightServo.setPosition(0);
            robot.LeftServo.setPosition(1);
            sleep(500);
        ...
        if (choice == 3) {
            //Right
            encoderDrive(DRIVE_SPEED, -10, -10, -10,-10,3.0);  // S1: Forward 12 Inches with 5 Sec timeout
            encoderDrive(TURN_SPEED, 14.8, -14.8,14.8,-14.8, 3.5);  // S2: Turn Right 6 Inches with 4 Sec timeout
            encoderDrive(DRIVE_SPEED, 3, 3, 3,3,2.0);  // S3: Forward 3 Inches with 4 Sec timeout
            encoderDrive(DRIVE_SPEED, 0, 0, 0,0,2.0);  // S4: Reverse 3 Inches with 4 Sec timeout
            robot.RightServo.setPosition(0);
            robot.LeftServo.setPosition(1);
            sleep(500);
            encoderDrive(DRIVE_SPEED, -3, -3, -3,-3,1.0);
            encoderDrive(TURN_SPEED,-6.5,6.5,-6.5,6.5,2.5);
        }
