...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
   public static double TICKS_PER_REV = 8192; // 8192 ticks per rev
   ...
   public static double Y_MULTIPLIER = 1.03;
   ...
   public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, ThorDrive drive) {
      super(Arrays.asList(
