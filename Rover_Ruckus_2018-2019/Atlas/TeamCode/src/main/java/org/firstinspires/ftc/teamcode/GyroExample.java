...
@Autonomous(name = "GyroExample", group = "RoboBot")
@Disabled
public class GyroExample extends LinearOpMode {

    // Declare OpMode members
    HardwareMapInit robot = new HardwareMapInit(); // Use the robot's hardware
    ...
    final double HEADING_THRESHOLD = 1 ; // As tight as we can make it with an integer gyro that's what he said
    ...
    public void gyroDrive ( double speed,
        ...
        if (opModeIsActive()) {
            ...
            moveCounts = (int)(distance * COUNTS_PER_INCH); // Parse to an int and set to moveCounts
            ...
            // Turn off the "RUN_TO_POSITION" mode
            robot.Left.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
            robot.Right.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        }
    }
