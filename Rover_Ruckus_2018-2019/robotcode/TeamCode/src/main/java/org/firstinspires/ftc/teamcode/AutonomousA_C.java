...
@Autonomous(name = "AutonomousA_C", group = "Auto")
public class AutonomousA_C extends LinearOpMode {
    ...
    public void movement() {
        ...
        forward(0.4, 0.5);
        turn(0.3, 1.2); //turn ccw at 0.5 speed for 1.25 seconds
        forward(0.4, 1.15);
        turn(-0.4, 0.3);
        //Move at an angle towards the perimeter for 2.5 seconds at 0.5-0.6 speed
        robot.Left.setPower(0.45);
