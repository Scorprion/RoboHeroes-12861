...
public class JanusRedCarouselRemote extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory move3 = robot.trajectoryBuilder(move2.end())
                .lineToLinearHeading(new Pose2d(-16, -48, Math.toRadians(270)))
                .build();
        robot.followTrajectory(move3);

        // Move forward to hub
        Trajectory move4 = robot.trajectoryBuilder(move3.end())
                .lineToLinearHeading(new Pose2d(hubXDistance, -hubdistance, Math.toRadians(270)))
                .build();
        ...
        Trajectory move8 = robot.trajectoryBuilder(move7.end())
                .lineToLinearHeading(new Pose2d(-11, -40, Math.toRadians(270)))
