...
@TeleOp(group = "Disco")
public class MimeTeleop extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (gamepad2.a) {
                driveTrain.LeftIntake.setPower(-1);
                driveTrain.RightIntake.setPower(1);
            } else if (gamepad2.b)  {
                driveTrain.LeftIntake.setPower(1);
                driveTrain.RightIntake.setPower(-1);
            } else {
                driveTrain.LeftIntake.setPower(0);
                driveTrain.RightIntake.setPower(0);
            }
            ...
            if ((gamepad2.left_stick_y >= 0.1 || gamepad2.left_stick_y <= -0.1)) {
                driveTrain.armLift.setPower(gamepad2.left_stick_y * 0.4);
            } else {
                driveTrain.armLift.setPower(0);
            }
