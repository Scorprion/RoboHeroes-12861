...
public class HermesD_Foundation extends HermesAggregated {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(pos == position.WALL) {
            ...
            sleep(250);
            encoderDrives(0.8, -111, -111, 10); //Move to the Build Zone to drop off the SkyStone
            ...
            encoderDrives(0.6, 12, 12, 3); //Drive forward to clamp the foundation
            encoderDrives(0.5, -17, -17, 3); //Drive back with the foundation
            ...
            mecanumMove(0.4, 90, 3, 4); //Strafe away from the SkyStone
            sleep(250);
            encoderDrives(0.8, -103, -103, 10); //Move to the Build Zone to drop off the SkyStone
            mecanumMove(-0.4, 90, 8, 3); //Strafe closer to the foundation
            robot.Gate.setPower(-0.4); //Lower the Arm
            sleep(250);
            robot.Clamper.setPower(1); //Release the SkyStone
            ...
            mecanumMove(0.4, 90, 3, 4); //Strafe away from the SkyStone
            sleep(250);
            encoderDrives(0.8, -95, -95, 10); //Move to the Build Zone to drop off the SkyStone
            mecanumMove(-0.4, 90, 8, 3); //Strafe closer to the foundation
            robot.Gate.setPower(-0.4); //Lower the Arm
            sleep(250);
            robot.Clamper.setPower(1); //Release the SkyStone
