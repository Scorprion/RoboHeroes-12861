...
public class HermesD extends HermesAggregated {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(pos == position.WALL) {
            ...
            sleep(250);
            mecanumMove(0.4, 90, 2, 4); //Strafe away from the SkyStone
            sleep(250);
            ...
            pidTurn(P, I, D, 0, 0, 1.25);
            sleep(250);
            encoderDrives(0.65, -70, -70, 10); //Drive back to the Build Zone to drop off 2nd SkyStone
            ...
            pidTurn(P, I, D, 0, 0, 1.25);
            sleep(250);
            encoderDrives(0.65, -62, -62, 10); //Drive back to the Build Zone to drop off 2nd SkyStone
            robot.Gate.setPower(-0.4); // Drop off the SkyStone
            sleep(250);
            robot.Clamper.setPower(1);
            sleep(1250);
            ...
            pidTurn(P, I, D, 0, 0, 1.25);
            sleep(250);
            encoderDrives(0.65, -54, -54, 10); //Drive back to the Build Zone to drop off 2nd SkyStone
            robot.Gate.setPower(-0.4); // Drop off the SkyStone
            sleep(250);
            robot.Clamper.setPower(1);
            sleep(1250);
