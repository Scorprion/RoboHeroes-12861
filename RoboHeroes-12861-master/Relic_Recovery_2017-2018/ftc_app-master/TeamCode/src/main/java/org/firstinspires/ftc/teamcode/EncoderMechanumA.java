...
public class EncoderMechanumA extends LinearOpMode  {
    ...
    public void cs(){
        ...
        robot.wtfudge.setPosition(0.8);
        robot.wtfudge2.setPosition(0.2);
    ...
    public void movement() {
        ...
        if (choice == 1) {
            ...
            sleep(500);
            encoderDrive(DRIVE_SPEED,-4,-4,-4,-4,1.5);
            encoderDrive(TURN_SPEED,-8,8,-8,8,2.0);
        }
        if (choice == 2) {
            //Middle
            encoderDrive(DRIVE_SPEED, 9.7, 9.7, 9.7, 9.7, 3.0);
            ...
            encoderDrive(DRIVE_SPEED,-3,-3,-3,-3,1.0);
            encoderDrive(TURN_SPEED,8.5,-8.5,8.5,-8.,2.0);
        ...
        if (choice == 3) {
            ...
            encoderDrive(TURN_SPEED,-6,6,-6,6,1.5);
            encoderDrive(DRIVE_SPEED,-3,-3,-3,-3,1.0);
            encoderDrive(TURN_SPEED,8.25,-8.25,8.25,-8.25,5.0);
